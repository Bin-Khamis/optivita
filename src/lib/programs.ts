...
const personalInfo: FormSection = {
  ...
  fields: [
    ...
    { name: "city", label: "City / Country", type: "text" },
    {
      ...
      type: "text",
      placeholder: "e.g. OPT-SUFAID-2142",
    },
  ],
};
...
const commitment: FormSection = {
  ...
  fields: [
    ...
    {
      name: "agree",
      label: "I commit to following the program guidance and weekly check-ins.",
      type: "checkbox",
      required: true,
    },
  ],
...
export const programs: Program[] = [
  {
    ...
    description:
      "A structured 30-day sprint with personalized meal planning, weekly check-ins, and daily WhatsApp accountability to help you lose weight sustainably.",
    ...
    formSections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "underDoctor",
            label: "Currently under a doctor's care?",
            type: "radio",
            options: ["Yes", "No"],
          },
  ...
  },
  {
    ...
    description:
      "Structured 8-week program combining meal planning, blood sugar education, and lifestyle coaching for people living with diabetes or prediabetes.",
        ...
        fields: [
          {
            ...
            label: "Diabetes type",
            type: "radio",
            options: ["Type 1", "Type 2", "Prediabetes", "Gestational", "Not sure"],
            required: true,
          },
          { name: "diagnosedYear", label: "Year diagnosed", type: "text" },
          {
            ...
            label: "Diagnosed by",
            type: "select",
            options: ["Family Physician", "Endocrinologist", "Hospital", "Other"],
          },
          { name: "hba1c", label: "Latest HbA1c (if known)", type: "text" },
          {
            ...
            type: "radio",
            options: ["Daily", "Twice daily", "Before meals", "After meals", "As advised"],
          },
  ...
  },
  {
    ...
    description:
      "A gentle 21-day reset focused on foundational habits: sleep, hydration, daily walking, and nutrition basics — perfect for a fresh start.",
  ...
  },
  {
    ...
    description:
      "A dedicated 12-week program addressing PCOS through hormone-supportive nutrition, weight management, and lifestyle adjustments.",
    ...
    formSections: [
      ...
      measurements,
      {
        ...
        fields: [
          {
            name: "diagnosed",
            label: "Have you been formally diagnosed with PCOS?",
            type: "radio",
          ...
          },
          {
            ...
            type: "radio",
            options: ["Regular", "Irregular", "Very infrequent", "No periods"],
          },
        ...
        fields: [
          {
            ...
            type: "checkbox",
            options: ["Insulin resistance", "Thyroid", "High cholesterol", "Hypertension", "None"],
          },
  ...
  },
  {
    ...
    description:
      "Our flagship 12-week premium program: weekly video calls, custom meal plans, workout guidance, and daily accountability.",
    ...
    formSections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "trainingDays",
            label: "Training days available per week",
            type: "select",
            options: ["2", "3", "4", "5", "6"],
          },
          {
            ...
            type: "checkbox",
            options: ["Full gym", "Home dumbbells", "Bodyweight only", "Outdoor / cardio"],
          },
        ...
        fields: [
          {
            ...
            label: "Preferred diet style",
            type: "select",
            options: ["No preference", "Vegetarian", "Vegan", "Keto", "Low Carb", "Mediterranean"],
          },
          {
            name: "mealsPerDay",
