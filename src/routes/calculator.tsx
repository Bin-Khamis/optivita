  ...
  head: () => ({
    meta: [
      { title: "Free Health & BMI Calculator — Optivita" },
      {
        name: "description",
        content:
          "Calculate your BMI, daily calorie needs, recommended water intake, and overall health score instantly with the Optivita Health Calculator.",
      },
      { property: "og:title", content: "Free Health & BMI Calculator — Optivita" },
      {
        property: "og:description",
        content: "Get your personalized BMI, calorie target, and health score instantly.",
      },
    ],
  }),
  ...
  const calculateHealth = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (bmiCategory === "Normal") {
        personalizedMessage +=
          "You are in a healthy weight category, which is fantastic! To maintain this progress and align your habits, our certified health coaches recommend staying active and following a tailored plan.";
      } else if (bmiCategory === "Underweight") {
        personalizedMessage +=
          "Your weight is slightly below the recommended range for your height. Building lean muscle mass and optimizing your nutrition can help you achieve a stronger, healthier profile safely.";
      } else {
        personalizedMessage +=
          "This indicates that you carry some excess weight. With precision nutrition adjustments and structured coaching, you can safely work towards your ideal weight range while boosting your daily energy.";
      }
      ...
      if (
        webhookUrl &&
        webhookUrl !== "https://script.google.com/macros/s/AKfycbx_placeholder/exec"
      ) {
        fetch(webhookUrl, {
          method: "POST",
          mode: "no-cors",
          ...
          .then(() =>
            console.log("Optivita Debug: Webhook submit complete (no-cors response is opaque)"),
          )
      ...
      <section className="relative pt-40 pb-16 bg-brand-gradient text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center md:text-left">
          ...
          <p className="mt-4 text-base md:text-lg text-white/90 max-w-2xl font-light">
            Enter your details below to get instant scientific insights about your BMI, healthy
            weight range, calorie goals, and a personalized wellness recommendation.
          </p>
        </div>
      </section>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    { val: "light", title: "Lightly Active", desc: "Light exercise 1-3 days/wk" },
                    {
                      ...
                      desc: "Moderate exercise 3-5 days/wk",
                    },
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="bg-card border border-border/80 rounded-3xl p-6 shadow-soft">
              ...
              <p className="text-xs text-muted-foreground mt-3 leading-relaxed">
                Health isn't just about weight—it's about understanding how your body utilizes
                energy and processes hydration. Our calculator runs calculations based on
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex items-start gap-2.5 text-xs text-muted-foreground">
                  ...
                  <span>
                    <strong>BMI Analysis</strong>: Identifies standard clinical weight
                    classifications for your height.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 text-xs text-muted-foreground">
                  <span className="h-1.5 w-1.5 rounded-full bg-vital mt-1.5 shrink-0" />
                  <span>
                    <strong>Calorie TDEE Needed</strong>: Mifflin-St Jeor formula calculates your
                ...
                <li className="flex items-start gap-2.5 text-xs text-muted-foreground">
                  <span className="h-1.5 w-1.5 rounded-full bg-vital mt-1.5 shrink-0" />
                  <span>
                    <strong>Hydration Target</strong>: Matches custom volume requirements to your
                    body mass and activity profile.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-brand-gradient text-white rounded-3xl p-6 shadow-soft relative overflow-hidden">
              ...
              <p className="text-xs text-white/80 mt-2 leading-relaxed">
                Calculators provide great general benchmarks, but they cannot replace a personalized
                health scan. Connect with Optivita coach for clinical assessment.
              </p>
              <a
                href="/#programs"
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-card border border-border/80 rounded-3xl p-6 shadow-soft relative overflow-hidden flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                    Estimated calorie target adjusted for your goal:{" "}
                    <strong className="text-foreground">
                      {inputs.primaryGoal === "lose"
                        ? "Lose Weight"
                        : inputs.primaryGoal === "gain"
                          ? "Gain Weight"
                          : inputs.primaryGoal === "maintain"
                            ? "Maintain Weight"
                            : "Optimized Wellness"}
                    </strong>
                    .
              ...
              <div className="bg-card border border-border/80 rounded-3xl p-6 shadow-soft relative overflow-hidden flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                    Optimal daily hydration target adjusted to your body weight and metabolic
                    profile.
                  </p>
                </div>
                <div className="mt-4 pt-3 border-t border-border/40 text-[10px] text-muted-foreground">
              ...
              <div className="bg-card border border-border/80 rounded-3xl p-6 shadow-soft relative overflow-hidden flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-3xl font-display font-bold text-foreground">
                      {results.dailySteps.toLocaleString()}
                    </span>
                    <span className="text-sm font-semibold text-muted-foreground">Steps/day</span>
                  </div>
                  <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                    Personalized active movement target based on your current physical activity
                    level.
                  </p>
                </div>
                <div className="mt-4 pt-3 border-t border-border/40 text-[10px] text-muted-foreground">
              ...
              <div className="bg-card border border-border/80 rounded-3xl p-6 shadow-soft relative overflow-hidden flex flex-col justify-between bg-accent/5 border-accent/20">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                    This program has been selected as the optimal match for your goals and
                    assessment score.
                  </p>
                </div>
                ...
                <div className="md:col-span-8 space-y-4">
                  ...
                  <div className="space-y-2 mt-4 text-white/90 text-sm md:text-base font-light">
                    <p className="flex items-center gap-2.5">
                      <span className="h-5 w-5 rounded-full bg-white/15 text-white flex items-center justify-center shrink-0">
                        ✓
                      </span>
                      Based on your results, we recommend:{" "}
                      <strong className="font-bold underline ml-1">
                        {results.recommendedProgramName}
                      </strong>
                    </p>
                    <p className="flex items-center gap-2.5">
                      ...
                      Structured deliverables, weekly clinical checks, and direct coach chat
                      support.
                    </p>
                  </div>
                </div>
          ...
          <div className="relative bg-card border border-border/80 rounded-3xl w-full max-w-md p-7 shadow-glow animate-scale-up z-10">
            ...
            <div className="text-center mt-2">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                Get your **FREE** health assessment from our certified nutrition experts. We will
                review your BMI calculations and design a customized path to your goals.
              </p>
            </div>
